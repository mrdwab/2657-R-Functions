...
```{r multi-freq-table2, tidy=FALSE}
# Make up some data
...
```{r multi-freq-table-extended, tidy=FALSE}
# Get the data
library(foreign)
...
```{r sample_size_exampes, tidy=FALSE}
# Load the function!
# require(RCurl)
# baseURL = c("https://raw.github.com/mrdwab/2657-R-Functions/master/")
...
```{r sample_size_advanced, tidy=FALSE}
